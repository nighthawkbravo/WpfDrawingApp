...
namespace WpfAppComputerGraphics2.Separate
{
    public static class BMConverter 
    {
        // This implementation of converting from Bitmaps to BitmapImages (and vice-versa) can be found with the following link.
